...
// Embed files
/*extern const uint8_t burros_blancos_LO0hfJxw_png_start[] asm("_binary_webpage_assets_burros_blancos_L0OhfJxw_png_start");
extern const uint8_t burros_blancos_LO0hfJxw_png_end[] asm("_binary_webpage_assets_burros_blancos_L0OhfJxw_png_end");

extern const uint8_t index_CAp_RRX2_css_start[] asm("_binary_webpage_assets_index_CAp_RRX2_css_start");
extern const uint8_t index_CAp_RRX2_css_end[] asm("_binary_webpage_assets_index_CAp_RRX2_css_end");

extern const uint8_t index_CLWZrPc7_js_start[] asm("_binary_webpage_assets_index_CLWZrPc7_js_start");
extern const uint8_t index_CLWZrPc7_js_end[] asm("_binary_webpage_assets_index_CLWZrPc7_js_end");
...
{
    extern const uint8_t _binary_webpage_assets_index_html_start[] asm("_binary_index_html_start");
    extern const uint8_t _binary_webpage_assets_index_html_end[] asm("_binary_index_html_end");
    const size_t index_html_size = _binary_webpage_assets_index_html_end - _binary_webpage_assets_index_html_start;

    httpd_resp_set_type(req, "text/html");
    httpd_resp_send(req, (const char *)_binary_webpage_assets_index_html_start, index_html_size);
    return ESP_OK;
}

esp_err_t index_js_get_handler(httpd_req_t *req)
{
    extern const uint8_t _binary_webpage_assets_index_CLWZrPc7_js_start[] asm("_binary_index_js_start");
    extern const uint8_t _binary_webpage_assets_index_CLWZrPc7_js_end[] asm("_binary_index_js_end");
    const size_t index_js_size = _binary_webpage_assets_index_CLWZrPc7_js_end - _binary_webpage_assets_index_CLWZrPc7_js_start;

    httpd_resp_set_type(req, "application/javascript");
    httpd_resp_send(req, (const char *)_binary_webpage_assets_index_CLWZrPc7_js_start, index_js_size);
    return ESP_OK;
}

esp_err_t index_css_get_handler(httpd_req_t *req)
{
    extern const uint8_t _binary_webpage_assets_index_CAp_RRX2_css_start[] asm("_binary_index_css_start");
    extern const uint8_t _binary_webpage_assets_index_CAp_RRX2_css_end[] asm("_binary_index_css_end");
    const size_t index_css_size = _binary_webpage_assets_index_CAp_RRX2_css_end - _binary_webpage_assets_index_CAp_RRX2_css_start;

    httpd_resp_set_type(req, "text/css");
    httpd_resp_send(req, (const char *)_binary_webpage_assets_index_CAp_RRX2_css_start, index_css_size);
    return ESP_OK;
}

esp_err_t image_png_get_handler(httpd_req_t *req)
{
    extern const uint8_t _binary_webpage_assets_burros_blancos_LO0hfJxw_png_start[] asm("_binary_burros_blancos_png_start");
    extern const uint8_t _binary_webpage_assets_burros_blancos_LO0hfJxw_png_end[] asm("_binary_burros_blancos_png_end");
    const size_t image_png_size = _binary_webpage_assets_burros_blancos_LO0hfJxw_png_end - _binary_webpage_assets_burros_blancos_LO0hfJxw_png_start;

    httpd_resp_set_type(req, "image/png");
    httpd_resp_send(req, (const char *)_binary_webpage_assets_burros_blancos_LO0hfJxw_png_start, image_png_size);
    return ESP_OK;
}
...
static httpd_handle_t http_server_configure(void)
{
    ...
    if (httpd_start(&http_server_handle, &config) == ESP_OK)
    {
        ...
        httpd_uri_t index_html_uri = {
            ...
            .user_ctx = NULL};
        httpd_register_uri_handler(http_server_handle, &index_html_uri);
        ...
        httpd_uri_t index_js_uri = {
            ...
            .user_ctx = NULL};
        httpd_register_uri_handler(http_server_handle, &index_js_uri);
        ...
        httpd_uri_t index_css_uri = {
            ...
            .user_ctx = NULL};
        httpd_register_uri_handler(http_server_handle, &index_css_uri);

        httpd_uri_t image_png_uri = {
            .uri = "/assets/burros_blancos.png",
            .method = HTTP_GET,
            .handler = image_png_get_handler,
            .user_ctx = NULL};
        httpd_register_uri_handler(http_server_handle, &image_png_uri);
